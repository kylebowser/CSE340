...
* *************************** */
async function addCat(classification_name){
  try {
...
module.exports = {getClassifications, getInventoryByClassificationId, getInventoryByInvId, addCat, addInv, updateInventory};